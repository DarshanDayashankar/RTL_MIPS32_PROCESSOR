...
`define OP_LW 6'b100100
`define OP_SW 6'b100101
`define OP_BEZ 6'b101000
`define OP_BNE 6'b101001
`define OP_JMP 6'b101010

// To be used in side ALU
`define OPERATOR_ADD 4'b0000
`define OPERATOR_SUB 4'b0010
`define OPERATOR_AND 4'b0100
`define OPERATOR_OR 4'b0101
`define OPERATOR_NOR 4'b0110
`define OPERATOR_XOR 4'b0111
`define OPERATOR_SLA 4'b1000
`define OPERATOR_SLL 4'b1000
`define OPERATOR_SRA 4'b1001
`define OPERATOR_SRL 4'b1010
`define OPERATOR_NOP 4'b1111 // for NOP, BEZ, BNQ, JMP
